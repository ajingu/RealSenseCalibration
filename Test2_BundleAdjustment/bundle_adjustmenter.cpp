...
struct ReprojectionError
{
	...
	ReprojectionError(const double* const observations, const double marker_side, const Mat& intrinsics, const Mat& dist_coeffs)
	...
	//RegionsAlias(Ç«Ç¡Ç©ÇÃÉÅÉÇÉäÇ™Ç©Ç‘Ç¡ÇƒÇµÇ‹Ç¡ÇƒÇ¢ÇÈ)
	template <typename T>
	...
	{
		return (new AutoDiffCostFunction<ReprojectionError, 8, 6, 6, 6>(
			new ReprojectionError(observations, marker_side, intrinsics, dist_coeffs)));
	}
};